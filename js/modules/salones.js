...
export class Clientes extends connect {
    ...
    async verificarTarjetaVIP(id, numeroTarjeta) {
        try {
     ...
     * @param {string} nickname - El apodo del usuario.
     * @param {string} email - El correo electrónico del usuario.
     * @param {string} telefono - El número de teléfono del usuario.
     * @param {string} contrasena - La contraseña del usuario (será encriptada).
     * @param {string} categoria - La categoría del usuario (Administrador, Usuario Estándar, Usuario VIP).
     * @returns {Object} Un objeto que indica el estado y el mensaje del resultado de la creación del usuario.
     */
    async crearUsuario(nombre, apellido, nickname, email, telefono, contrasena, categoria) {
        try {
            // Validar que el email, telefono y nickname no estén en uso
